...
parser.add_argument('--model_name', default='ver1_e15.pth.tar', type=str)
parser.add_argument('--img_root', default=r'D:\Desk From C\日常\摆烂\大创\construction\2023-04-08-10-09-36-insightface-master\insightface-master\recognition\_datasets_\casia_fold1\clean', type=str)
parser.add_argument('--test_mode', default='casia', type=str)
...
test_list_dir = f'{tmp}/PR-HFR-main/PR-HFR-main/data/casia/'
model_dir = f'{tmp}/model/{test_mode}/'
